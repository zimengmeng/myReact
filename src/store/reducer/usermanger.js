import { USERMANGER_ADD_USER, USERMANGER_INIT_USER, USERMANGER_ISADD, USERMANGER_USER_DEL, USERMANGER_ISDEL, USERMANGER_EDIT_USER, USERMANGER_ISEDIT } from '../action/usermanger'
...
export let usermanger = (state = { userlist: [], isAdd: null }, action) => {
